...
# KBhattarai, 11.13.2019,Modified code to complete assignment 6
# ------------------------------------------------------------------------ #
...
class FileProcessor:
    ...
    def WriteListDataToFile(file_name, list_of_rows):
        ...
        :return: nothing
        """
        pass #Added code here

        objFile = open(file_name, 'w')
        for dicRow in list_of_rows:     #Write each row of data to file
    ...
    def AddRowToList(Task, Priority, list_of_row):
        ...
        :param Priority: (string) with of priority level:
        :param list_of_row: (list) you want filled with file data:
        :return: nothing
        """
        dicRow = {"Task": Task, "Priority": Priority}  # Create a new dictionary row
        list_of_row.append(dicRow)  # Add the new row to the list/table
...
# Step 3.2 - Add a new item to the list/Table
        ...
        # Placed IO code in a new function
        IO.userTaskInput()
